...
movies %>%
  ...
  drop_na(budget)
```
We remove the year with our choose, so the filter is ineffective, hence the code is broken. Since the budget remains in the data following the select code, the drop_na budget may still function.
...
```
"Blacksmith Scene" from 1893 is the oldest film, and "Cure for Insomnia, The" is the longest.
...
movies_Ques2
```
The films "Big Fish," "Forrest Gump," "Homem Que Copiava, O," and "Incredibles, The" were screened.
...
movies_Ques3
```
This data includes three films: Harry Potter and the Sorcerer's Stone, Harry Potter and the Chamber of Secrets, and Harry Potter and the Prisoner of Azkaban. "Harry Potter and the Prisoner of Azkaban" has the greatest rating of any Harry Potter film. "Harry Potter and the Sorecerer's Stone" is the most-voted Harry Potter film.
...
movies_Ques4
```
With at least 100 votes, "Wild Wild West" has the most budget of any comedy or animated film.
